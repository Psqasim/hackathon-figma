    ...
    <div className="w-full min-h-screen bg-[#FAFAFA] flex justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-[1050px] h-full">
        <div className="w-full bg-[#FFFFFF] py-6 sm:py-8">
          ...
          <div className="w-full max-w-[870px] mx-auto px-4 sm:px-6 flex items-center justify-center">
            <div className="w-full max-w-[427px] text-center sm:text-left">
              <h1 className="font-semibold text-[16px] leading-6 tracking-[0.1px] text-[#737373]">
                PRICING
              </h1>
              <h1 className="mt-4 text-[32px] sm:text-[48px] lg:text-[58px] font-semibold leading-tight sm:leading-[80px] tracking-[0.2px] text-[#252B42]">
                Simple Pricing
              </h1>
              <div className="flex justify-center sm:justify-start gap-4 mt-3">
                <Link
                  href="/"
                  className="font-semibold text-[14px] leading-6 text-[#252B42]"
                >
                  Home
                </Link>
                <Image src={Arrowicon} alt="Arrowicon" />
                <p className="font-semibold text-[14px] leading-6 text-[#737373]">
                  Pricing
                </p>
              </div>
            </div>
        ...
        <div className="w-full max-w-[625px] mx-auto mt-7 px-4 text-center">
          <h1 className="font-semibold text-[32px] sm:text-[40px] leading-[1.2] sm:leading-[50px]">
            Pricing
          </h1>
        ...
        <div className="flex justify-center mt-10">
          <div className="flex flex-wrap items-center gap-4 justify-center">
            <div className="flex items-center gap-3">
              <p className="text-[#252B42] font-semibold text-[16px]">
                Monthly
              </p>
        ...
        <div className="w-full mt-10 px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[985px] mx-auto">
            <div className="bg-[#FFFFFF] rounded-[10px] p-6 sm:p-10 text-center flex flex-col gap-7 items-center">
              <h1 className="font-semibold text-[24px] leading-8 text-[#252B42]">
                FREE
              </h1>
              <p className="max-w-[160px] font-semibold text-[16px] text-[#737373] leading-6">
                Organize across all apps by hand
              </p>
              <div className="flex items-start gap-2">
                <p className="font-semibold text-[40px] text-[#23A6F0] leading-[50px]">
                  0
                </p>
                <div className="flex flex-col">
                  <p className="font-semibold text-[24px] text-left text-[#23A6F0]">
                    $
                  </p>
                  <p className="font-semibold text-[14px] text-[#8EC2F2]">
                    Per Month
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <p className="font-semibold text-[14px] text-[#252B42] leading-6">
            ...
            <div className="bg-[#252B42] rounded-[10px] p-6 sm:p-10 text-center flex flex-col gap-7 items-center">
              <h1 className="font-semibold text-[24px] leading-8 text-[#FFFFFF]">
                STANDARD
              </h1>
              <p className="max-w-[160px] font-semibold text-[16px] text-[#FFFFFF] leading-6">
                Organize across all apps by hand
              </p>
              <div className="flex items-start gap-2">
                <p className="font-semibold text-[40px] text-[#23A6F0] leading-[50px]">
              ...
              <div className="flex items-center gap-2">
                <Image src={Checkcircle} alt="Checkcircle" />
                <p className="font-semibold text-[14px] text-[#FFFFFF] leading-6">
                  Unlimited product updates
                </p>
              </div>
            </div>
        ...
        <div className="text-center mt-20">
          <p className="text-[18px] sm:text-[20px] leading-8">
            Trusted By Over 4000 Big Companies
          </p>
        </div>

        <div className="w-full py-8 mt-7 px-4">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-8 justify-items-center items-center">
